...
# ==============================================================================
"""Contains the definition of Stacked 2D-LSTM architecture."""
...
class MultiDimensionalLSTMCell(RNNCell):
    ...
    def __call__(self, inputs, state, scope=None):
        ...
        with tf.variable_scope(scope or type(self).__name__):
            c1, c2, c3, h1, h2, h3 = state

            # change bias argument to False since LN will add bias via shift
            concat = _linear([inputs, h1, h2, h3], 6 * self._num_units, False)

            i, j, f1, f2, f3, o = tf.split(value=concat, num_or_size_splits=6, axis=1)
            ...
            new_c = (c1 * tf.nn.sigmoid(f1 + self._forget_bias) +
                     ...
                     c3 * tf.nn.sigmoid(f3 + self._forget_bias) +
    ...
    def multi_dimensional_rnn_while_loop(self, rnn_size, input_data, sh, dims=None, scope_n="layer1"):
        ...
        with tf.variable_scope("MultiDimensionalLSTMCell-" + scope_n):
            ...
            def body(time_, outputs_ta_, states_ta_):
                ...
                current_state = state_up[0], state_last[0], state_up_last[0],\
                                state_up[1], state_last[1], state_up_last[1]
